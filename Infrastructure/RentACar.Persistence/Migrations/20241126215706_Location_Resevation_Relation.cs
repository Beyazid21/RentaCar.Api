...
{
    /// <inheritdoc />
    public partial class Location_Resevation_Relation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_GetLocations_DropOffLocationId",
                        column: x => x.DropOffLocationId,
                        principalTable: "GetLocations",
                        principalColumn: "LocationId");
                    table.ForeignKey(
                        name: "FK_Reservations_GetLocations_PickUpLocationId",
